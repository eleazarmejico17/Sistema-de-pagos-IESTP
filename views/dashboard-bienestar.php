...
$menu = [
  'registro-bienestar-estudiantil' => ['icon' => '➕', 'texto' => 'NUEVO'],
  'reportes-bienestar-estudiantil' => ['icon' => '📊', 'texto' => 'REPORTES'],
  'solicitud-bienestar-estudiantil' => ['icon' => '📄', 'texto' => 'SOLICITUDES'],
];
...
function activo($actual, $pagina) {
  return $actual === $pagina
    ? 'bg-gray-800 text-white rounded-lg px-4 py-2'
    : 'hover:bg-gray-800 transition px-4 py-2';
}
?>
